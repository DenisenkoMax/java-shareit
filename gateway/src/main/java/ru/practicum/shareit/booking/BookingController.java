...
public class BookingController {
    ...
    public ResponseEntity<Object> getBookings(
            ...
            @Positive @RequestParam(name = "size", defaultValue = "10") Integer size) throws IllegalArgumentEx {
    ...
    public ResponseEntity<Object> handleBookingRequest(@PathVariable Long bookingId,
                                                       @RequestHeader("X-Sharer-User-Id") Long userId,
                                                       @RequestParam boolean approved) {
        return bookingClient.handleBookingRequest(bookingId, userId, approved);
    }
